...
public class ApplicationLayer extends ArchitectureElement {
  ...
  private final HexagonalArchitectureIT parentContext;
  ...
  public ApplicationLayer(String basePackage, HexagonalArchitectureIT parentContext) {
    super(basePackage);
  ...
  public HexagonalArchitectureIT and() {
